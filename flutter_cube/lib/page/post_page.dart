...
class PostPage extends StatefulWidget {
  ...
  const PostPage({Key? key, required this.token, required this.userId})
      : super(key: key);
                ...
                IconButton(
                    onPressed: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (BuildContext context) => NewResourcePage(
